...
// type PercentageSymbolParser<S extends string> = S extends `${infer Value}%`? [Value, "%"]: [S, ""]
// type PercentageParser<S extends string> = S extends `${infer Signal extends "+"|"-"}${infer Rest}`
//   ? [Signal, ...PercentageSymbolParser<Rest>]
//   : ["", ...PercentageSymbolParser<S>];
