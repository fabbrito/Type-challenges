...
// type AnyOf<T extends readonly any[]> = T extends [infer E, ...infer R]
//   ? E extends 0 | "" | [] | false | Record<string, never>
//     ? AnyOf<R>
//     : true
//   : false;

// From https://github.com/type-challenges/type-challenges/issues/954
