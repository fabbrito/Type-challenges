...
// Solution by Canvascat (https://github.com/type-challenges/type-challenges/issues/13913)
type Chainable2<Obj extends object = {}> = {
  option<Key extends PropertyKey, Value>(
    key: Key,
    value: Key extends keyof Obj
      ? // It is forbidden to set a key with the same value type
    ...
    (Key extends keyof Obj
      ? // Attributes set after the same key is used, need to exclude the previously set attributes
        Obj[Key] extends Value
        ? Obj
        : Omit<Obj, Key>
      : Obj) &
...
// Solution by Acorn1010 (https://github.com/type-challenges/type-challenges/issues/13248)
