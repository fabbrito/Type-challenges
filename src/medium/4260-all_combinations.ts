...
// from https://github.com/type-challenges/type-challenges/issues/14096
...
// type AllCombinations2<S extends string, A extends string = StrToUnion<S>, U extends string = A> = [U] extends [never]
//   ? ""
//   : U extends A
//   ? "" | U | `${U}${AllCombinations2<"", Exclude<A, U>>}`
//   : never;
