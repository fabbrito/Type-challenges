...
// Merge<T, U>: Merge T and U, with the properties of U overriding those of T
// First it removes from T what coincides between T and U, then computes the intersection with U
type Merge<T, U> = Omit<Omit<T, keyof T & keyof U> & U, never>;
