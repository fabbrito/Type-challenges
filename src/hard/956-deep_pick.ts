...
type Get<Obj, Path extends string> = Path extends `${infer FirstKey}.${infer OtherKeys}`
  ? FirstKey extends keyof Obj
    ? Record<FirstKey, Get<Obj[FirstKey], OtherKeys>>
    : never
...
type DeepPick<O extends object, S extends string> = UnionToIntersection<Get<O, S>>;
